...
public class ServiceVenta_Compra implements IServiceVenta_Compra {
    ...
    @Autowired
    public ServiceVenta_Compra(ClienteRepository repositoryCliente, DescuentoRepository repositoryDescuento, ViajeRepository viajeRepository, VentaCompraRepository repositoryVentaCompra, IServicePago servicePago) {
    ...
    public Venta_Compra armarVenta(DtVenta_Compra compra) {
		try {
			...
			return crearVenta(cliente, pago, venta.getTipoDescuento());
		}catch(Exception e) {
			throw e;
		}
	}
    ...
    public Venta_Compra crearVenta(Cliente cliente, Pago pago, String tipoDescuento) {
