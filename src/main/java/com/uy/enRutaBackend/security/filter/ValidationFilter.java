...
import com.uy.enRutaPoC.security.SimpleGrantedAuthorityJsonCreator;
...
public class ValidationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            Claims claims = Jwts.parser().verifyWith(Jwts.SIG.HS256.key().build()).build().parseSignedClaims(token).getPayload();
